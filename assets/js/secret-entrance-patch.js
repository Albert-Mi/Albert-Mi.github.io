/* assets/js/secret-entrance-patch.js
   Guarantee the secret-entrance trigger is visible: insert it ABOVE the Dark Mode toggle,
   inside the sticky bottom block, and re-apply on PJAX swaps.
*/
(function () {
