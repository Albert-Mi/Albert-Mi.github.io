...
<div id="transformer-explainer"></div>
<nav class="fta-toc" aria-label="Table of contents"><div class="fta-toc-title">Contents</div><ol><li class="fta-toc-level-2"><a href="#section-1">Transformer、ALM、LLM和Agent</a></li>
...
<li class="fta-toc-level-2"><a href="#references">References</a></li></ol></nav>
...
<figure class="fta-figure"><svg class="fta-svg-diagram" viewBox="0 0 590 240" role="img" aria-label="diagram"><defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 z"></path></marker></defs><path d="M175,124 C200,124 165,124 190,124"></path><path d="M310,124 C335,124 300,124 325,124"></path><path d="M445,124 C470,124 435,124 460,124"></path><rect x="55" y="100" width="120" height="48" rx="8"></rect><text x="115" y="130">H</text><rect x="190" y="100" width="120" height="48" rx="8"></rect><text x="250" y="130">Q/K/V</text><rect x="325" y="100" width="120" height="48" rx="8"></rect><text x="385" y="130">Heads</text><rect x="460" y="100" width="120" height="48" rx="8"></rect><text x="520" y="130">Concat + W_O</text></svg><figcaption>多头注意力：输入 $H$ 被投影到多个子空间，各头独立计算注意力后再拼接。</figcaption></figure>
...
<figure class="fta-figure"><svg class="fta-svg-diagram" viewBox="0 0 590 240" role="img" aria-label="diagram"><defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 z"></path></marker></defs><path d="M175,124 C200,124 165,124 190,124"></path><path d="M310,124 C335,124 300,124 325,124"></path><path d="M445,124 C470,124 435,124 460,124"></path><path d="M580,124 C605,124 30,124 55,124"></path><rect x="55" y="100" width="120" height="48" rx="8"></rect><text x="115" y="130">H</text><rect x="190" y="100" width="120" height="48" rx="8"></rect><text x="250" y="130">Q/K/V</text><rect x="325" y="100" width="120" height="48" rx="8"></rect><text x="385" y="130">Heads</text><rect x="460" y="100" width="120" height="48" rx="8"></rect><text x="520" y="130">Concat + W_O</text></svg><figcaption>原始 Transformer 的 Encoder--Decoder 流程：Encoder 编码源序列，Decoder 结合目标前缀和 Encoder 输出逐步生成目标 token。</figcaption></figure>
...
<figure class="fta-figure"><svg class="fta-svg-diagram" viewBox="0 0 590 240" role="img" aria-label="diagram"><defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 z"></path></marker></defs><path d="M175,124 C200,124 165,124 190,124"></path><path d="M310,124 C335,124 300,124 325,124"></path><path d="M445,124 C470,124 435,124 460,124"></path><path d="M580,124 C605,124 30,124 55,124"></path><rect x="55" y="100" width="120" height="48" rx="8"></rect><text x="115" y="130">H</text><rect x="190" y="100" width="120" height="48" rx="8"></rect><text x="250" y="130">Q/K/V</text><rect x="325" y="100" width="120" height="48" rx="8"></rect><text x="385" y="130">Heads</text><rect x="460" y="100" width="120" height="48" rx="8"></rect><text x="520" y="130">Concat + W_O</text></svg><figcaption>三类常见 Transformer 架构：Encoder-only 偏重表示学习，Decoder-only 偏重自回归生成，Encoder-Decoder 偏重条件生成。</figcaption></figure>
...
<div class="fta-table-scroll"><table class="fta-table"><tr><th>p{4cm}p{3.8cm}p{3cm}} <strong>架构</strong></th><th><strong>可见信息</strong></th><th><strong>主要目标</strong></th><th><strong>代表模型</strong></th></tr><tr><td>Encoder-only</td><td>整个输入序列，双向可见</td><td>表示学习、理解任务</td><td>BERT</td></tr><tr><td>Decoder-only</td><td>只能看见前文，单向生成</td><td>自回归生成 $P(x_t|x_{&lt;t})$</td><td>GPT, LLaMA</td></tr><tr><td>Encoder-Decoder</td><td>输入全可见，输出端单向生成</td><td>条件生成 $P(y_t|y_{&lt;t},x)$</td><td>Transformer, T5, BART</td></tr></table></div>
<aside class="fta-callout fta-summary"><div class="fta-callout-title">Summary</div>
...
<figure class="fta-figure"><svg class="fta-svg-diagram" viewBox="0 0 590 240" role="img" aria-label="diagram"><defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 z"></path></marker></defs><path d="M175,124 C200,124 165,124 190,124"></path><path d="M310,124 C335,124 300,124 325,124"></path><path d="M445,124 C470,124 435,124 460,124"></path><path d="M580,124 C605,124 30,124 55,124"></path><rect x="55" y="100" width="120" height="48" rx="8"></rect><text x="115" y="130">H</text><rect x="190" y="100" width="120" height="48" rx="8"></rect><text x="250" y="130">Q/K/V</text><rect x="325" y="100" width="120" height="48" rx="8"></rect><text x="385" y="130">Heads</text><rect x="460" y="100" width="120" height="48" rx="8"></rect><text x="520" y="130">Concat + W_O</text></svg><figcaption>MAC 架构：长期记忆读出作为注意力上下文。</figcaption></figure>
...
<ol>
<li><strong>Transformer</strong>：基于数据依赖核的积分型离散算子，在有限窗口内做高精度条件平均。核心计算：$o_t = \sum_j A_{tj} v_j$，其中 $A_{tj} = \softmax(q_t\cdot k_j / \sqrt{d_k})$。</li>
...
<p>令 $p = \softmax(z)$，即 $p_i = e^{z_i} / \sum_k e^{z_k}$。记 $S = \sum_k e^{z_k}$。对任意 $i,j$，用商法则求导：</p>
<div class="fta-math">\[
\begin{aligned}
...
<div class="fta-math">\[
\begin{aligned}
J_{\softmax}(z) = \diag(p) - p p^\top \;\in\; \mathbb{R}^{V\times V}.
\end{aligned}
\]</div>
<p>其中 $\diag(p)$ 是以 $p$ 为对角元素的对角矩阵，$p p^\top$ 是外积矩阵（第 $(i,j)$ 元为 $p_i p_j$）。</p>
...
<figure class="fta-figure"><svg class="fta-svg-diagram" viewBox="0 0 590 240" role="img" aria-label="diagram"><defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 z"></path></marker></defs><path d="M175,69 C200,69 195,69 220,69"></path><path d="M340,69 C365,69 360,69 385,69"></path><path d="M505,69 C530,69 360,184 385,184"></path><path d="M505,184 C530,184 195,184 220,184"></path><path d="M340,184 C365,184 30,184 55,184"></path><path d="M175,184 C200,184 30,69 55,69"></path><rect x="55" y="45" width="120" height="48" rx="8"></rect><text x="115" y="75">目标 g</text><rect x="220" y="45" width="120" height="48" rx="8"></rect><text x="280" y="75">LLM 策略</text><rect x="385" y="45" width="120" height="48" rx="8"></rect><text x="445" y="75">行动</text><rect x="385" y="160" width="120" height="48" rx="8"></rect><text x="445" y="190">环境/工具</text><rect x="220" y="160" width="120" height="48" rx="8"></rect><text x="280" y="190">观测</text><rect x="55" y="160" width="120" height="48" rx="8"></rect><text x="115" y="190">状态</text></svg><figcaption>Agent 的闭环：策略产生行动，环境返回观测，状态更新后再次影响策略。这等价于一个带反馈的离散动力系统。</figcaption></figure>
...
<figure class="fta-figure"><svg class="fta-svg-diagram" viewBox="0 0 590 240" role="img" aria-label="diagram"><defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 z"></path></marker></defs><path d="M175,69 C200,69 195,69 220,69"></path><path d="M340,69 C365,69 360,69 385,69"></path><path d="M505,69 C530,69 360,184 385,184"></path><path d="M505,184 C530,184 195,184 220,184"></path><path d="M340,184 C365,184 30,184 55,184"></path><path d="M175,184 C200,184 30,69 55,69"></path><rect x="55" y="45" width="120" height="48" rx="8"></rect><text x="115" y="75">输入标准化</text><rect x="220" y="45" width="120" height="48" rx="8"></rect><text x="280" y="75">状态管理</text><rect x="385" y="45" width="120" height="48" rx="8"></rect><text x="445" y="75">LLM 策略</text><rect x="385" y="160" width="120" height="48" rx="8"></rect><text x="445" y="190">行动解析</text><rect x="220" y="160" width="120" height="48" rx="8"></rect><text x="280" y="190">工具执行</text><rect x="55" y="160" width="120" height="48" rx="8"></rect><text x="115" y="190">校验与安全</text></svg><figcaption>最小可实现 Agent 架构：每条箭头都应有明确数据结构。箭头上的数据依次为：输入文本、状态摘要、策略提示、结构化行动、工具参数、工具返回、校验结果。</figcaption></figure>
<p>策略模型接收的提示拆为五部分：</p>
<div class="fta-math">\[
\begin{aligned}
...
\end{aligned}
\]</div>
<p>雅可比矩阵：$J_{\softmax}(z) = \diag(p) - pp^\top$。半正定性：$u^\top J u = \Var_{i\sim p}(u_i) \ge 0$。</p>
...
<script src="transformer-explainer.js" defer></script>
